...
pokeyellow_pl_obj       := $(rom_obj)
# pokeyellow_debug_obj := $(rom_obj:.o=_debug.o)
pokeyellow_pl_vc_obj    := $(rom_obj:.o=_vc.o)
...
all: $(roms)
yellow:       pokeyellow_pl.gbc
# yellow_debug: pokeyellow_debug.gbc
yellow_vc:    pokeyellow_pl.patch
...
$(pokeyellow_pl_vc_obj):    RGBASMFLAGS += -D _YELLOW_VC
...
$(foreach obj, $(pokeyellow_pl_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
# $(foreach obj, $(pokeyellow_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(pokeyellow_pl_vc_obj), $(eval $(call DEP,$(obj),$(obj:_vc.o=.asm))))
...
pokeyellow_pl_pad       = 0x00
# pokeyellow_debug_pad = 0xff
pokeyellow_pl_vc_pad    = 0x00
